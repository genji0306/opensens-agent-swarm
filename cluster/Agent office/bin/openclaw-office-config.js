...
export function printHelp() {
  console.log(`
  \x1b[36mOpensens Office\x1b[0m — Visual monitoring frontend for Opensens DarkLab

  \x1b[1mUsage:\x1b[0m
    opensens-office [options]
  ...
  \x1b[1mExamples:\x1b[0m
    opensens-office
    opensens-office --token <token>
    opensens-office --gateway ws://gateway.example.com:18789
    PORT=3000 opensens-office
`);
}
