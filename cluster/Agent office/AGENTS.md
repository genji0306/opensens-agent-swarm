# Opensens Office — Agent Development Guide
...
Opensens Office is the visual monitoring and management frontend for the [Opensens](https://github.com/openclaw/openclaw) Multi-Agent system. It connects to the Opensens Gateway via WebSocket to visualize Agent collaboration as a "digital office" and provides a full console management interface.
...
- Oxlint + Oxfmt formatting (consistent with Opensens main project)
- Comments only for non-obvious logic

## Opensens Gateway Integration
...
## Key Reference Files (Opensens Main Repo)

The following files in the Opensens main repository contain authoritative Gateway protocol and type definitions:
