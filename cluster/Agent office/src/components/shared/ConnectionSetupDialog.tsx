      ...
      >
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="inline-flex min-w-36 items-center justify-center rounded-xl bg-sky-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-sky-500 disabled:cursor-not-allowed disabled:opacity-60"
          >
  ...
  return (
    <button
      ...
      className={`rounded-2xl border p-5 text-left transition ${
        active
          ? "border-sky-500 bg-sky-50 shadow-sm dark:border-sky-400 dark:bg-sky-950/30"
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none ring-0 transition placeholder:text-slate-400 focus:border-sky-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50"
      />
