...
export function formatStartupSummary(config) {
  const lines = [
    "",
    "  \x1b[36m\u{1F3E2} Opensens Office\x1b[0m",
    "",
  ...
  if (config.token) {
    ...
    lines.push("  \x1b[90m  opensens-office --token <your-token>\x1b[0m");
    lines.push("  \x1b[90m  or provide a token via environment variable\x1b[0m");
  }
