...
export interface OfficeStore {
  ...
  // DRVP visual status by agent name (for cross-source events)
  setAgentVisualStatusByName: (name: string, status: AgentVisualStatus) => void;
