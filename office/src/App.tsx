...
import { useDrvpConnection } from "@/hooks/useDrvpConnection";
import { useGatewayConnection } from "@/hooks/useGatewayConnection";
import { usePaperclipPolling } from "@/hooks/usePaperclipPolling";
...
export function App() {
  ...
  // DRVP SSE connection to Leader for real-time governance events
  useDrvpConnection({
    leaderUrl: import.meta.env.VITE_LEADER_URL || "",
    companyId: import.meta.env.VITE_DRVP_COMPANY_ID || "",
  });

  // Paperclip REST polling for governance dashboard data
  usePaperclipPolling({
    baseUrl: import.meta.env.VITE_PAPERCLIP_URL || "",
    companyId: import.meta.env.VITE_DRVP_COMPANY_ID || "",
  });
